<?php /* Smarty version 2.6.27, created on 2016-03-09 14:51:21
         compiled from main_frame.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'printXMLDeclaration', 'main_frame.tpl', 1, false),array('modifier', 'script_escape', 'main_frame.tpl', 28, false),array('modifier', 'count', 'main_frame.tpl', 65, false),array('modifier', 'h', 'main_frame.tpl', 93, false),array('modifier', 'sfDispDBDate', 'main_frame.tpl', 94, false),array('modifier', 'date_format', 'main_frame.tpl', 166, false),)), $this); ?>
...
<div id="navi-wrap">
    <ul id="navi" class="clearfix">
        <?php if (((is_array($_tmp=$this->_tpl_vars['authority'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) < 2): ?>
...
unset($_smarty_tpl_vars);
 ?>
        ...
        <?php if (((is_array($_tmp=$this->_tpl_vars['authority'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 0): ?>
